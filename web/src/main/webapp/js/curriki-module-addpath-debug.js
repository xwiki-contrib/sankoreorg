...
Curriki.module.addpath.init = function() {
  ...
  // TODO: Removed for EOU1, add back in EOU2
    ...
    AddPath.UrlMetadata1 = Ext.extend(Curriki.ui.dialog.Actions, {
      initComponent:function(){
        Ext.apply(this, {
          ...
          ,items:[{
            ...
            ,bbar:['->'
              // Publish now
              ,{ 
                text:_('add.setrequiredinfo.url.publish.button')
                ,id:'publishbutton'
                ...
                ,{
                  text:_('add.setrequiredinfo.url.next.button')
                  ,id:'nextbutton'
                  ,cls:'button button-confirm'
                  ,listeners:{
                    click:{
              ...
              ,items:[{ // Url
                ...
                ,autoEl:{
                  ...
                  ,children:[{
                     tag:'em'
                    ,id:'metadata-link-required'
                    ,cls:'required-indicator'
                    ,html:_('form.required.fields.indicator')
                  },{
                     tag:'span'
                    ,id:'metadata-link-title'
                    ,cls:'metadata-link'
                    ,html:_('sri.link_title')
                  },{
                     tag:'img'
                    ,id:'metadata-link-info'
                    ,cls:'metadata-tooltip'
                    ,src:Curriki.ui.InfoImg
                    ,qtip:_('sri.link_tooltip')
                  }]
                }
              },{
                 xtype:'textfield'
    ...
    AddPath.UrlMetadata2 = Ext.extend(Curriki.ui.dialog.Actions, {
        initComponent:function(){
        Ext.apply(this, {
                ...
                click:{
                   fn: function(){
                    ...
                    if (form.isValid()){
                      ...
                      Ext.each(['subject', 'level', 'ict'], function(item){
                        var invalid = null;
