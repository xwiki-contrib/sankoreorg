...
public class CurrikiPlugin extends XWikiDefaultPlugin implements XWikiPluginInterface, XWikiDocChangeNotificationInterface {
    ...
    private void initAssetClass(XWikiContext context) throws XWikiException {
        ...
        needsUpdate |= bclass.addDBTreeListField(Constants.ASSET_CLASS_EDUCATIONAL_LEVEL, Constants.ASSET_CLASS_EDUCATIONAL_LEVEL, 10, true, Constants.ASSET_CLASS_EDUCATIONAL_LEVEL_QUERY);
        ((DBTreeListClass)bclass.get(Constants.ASSET_CLASS_EDUCATIONAL_LEVEL)).setCache(true);
        ((DBTreeListClass)bclass.get(Constants.ASSET_CLASS_EDUCATIONAL_LEVEL)).setSeparators("|");
        ((DBTreeListClass)bclass.get(Constants.ASSET_CLASS_EDUCATIONAL_LEVEL)).setSeparator(" ");
        ((DBTreeListClass)bclass.get(Constants.ASSET_CLASS_EDUCATIONAL_LEVEL)).setPicker(true);
        needsUpdate |= bclass.addDBTreeListField(Constants.ASSET_CLASS_INSTRUCTIONAL_COMPONENT, Constants.ASSET_CLASS_INSTRUCTIONAL_COMPONENT, 10, true, Constants.ASSET_CLASS_INSTRUCTIONAL_COMPONENT_QUERY);
        ((DBTreeListClass)bclass.get(Constants.ASSET_CLASS_INSTRUCTIONAL_COMPONENT)).setCache(true);
        ((DBTreeListClass)bclass.get(Constants.ASSET_CLASS_INSTRUCTIONAL_COMPONENT)).setSeparators("|");
        ((DBTreeListClass)bclass.get(Constants.ASSET_CLASS_INSTRUCTIONAL_COMPONENT)).setSeparator(" ");
        ((DBTreeListClass)bclass.get(Constants.ASSET_CLASS_INSTRUCTIONAL_COMPONENT)).setPicker(true);
